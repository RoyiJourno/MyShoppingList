...
public class CustomAdapter  extends BaseAdapter {
    ...
    @Override
    public int getCount() {
        return listOfProduct.modelArrayList.size();
    }

    @Override
    public Object getItem(int position) {
        return listOfProduct.modelArrayList.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tvFruit.setText(listOfProduct.modelArrayList.get(position).getProduct());
        holder.tvDesc.setText(listOfProduct.modelArrayList.get(position).getproductDesc());
        holder.tvnumber.setText(String.valueOf(listOfProduct.modelArrayList.get(position).getNumber()));
        ...
        holder.btn_plus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                listOfProduct.modelArrayList.get(pos).setNumber(number);
